...
<div class="content">
	...
	<div class="shop-content" style="width:3000px;margin-left:20px;">
    ...
    <!-- Wrapper for slides -->
    		<div class="carousel-inner">
      			<div class="item active">
        			<img src="images/m12.jpg" alt="" style="width:7500px;height:800px;">
      			</div>

      			<div class="item">
        			<img src="images/m10.jpg" alt="" style="width:5500px;height:800px;">
      			</div>
    
      			<div class="item">
        			<img src="images/m11.jpg" alt="" style="width:5500px;height:800px;">
     			</div>
    		</div>
	...
	<div class="content">
		...
		<h2 style="text-align: center;color: #ff3490;"><b><u>RECENT POSTS</u></b></h2><br><br>

		<?php		
									$a="select * from mag where category='Magazines' or category='Newspapers' order by rand() limit 12";
									$exe=mysqli_query($cf,$a);
...
<div class="card"><form name="m" method="post" enctype="multipart/form-data" action="">
	<h5 style="text-align:center"><b><?php echo $fetch['name']; ?></b></h5>
	<a href="cart.php?id=<?php echo $fetch['id'] ?>" name="link">
  <img class="cover" src="../admin/productimage/newspapers/<?php echo $fetch['image'] ?>" alt="image" style="width: 250px;height: 300px;align-self: center;">
  <img class="cover" src="../admin/productimage/magazines/<?php echo $fetch['image'] ?>" alt="" style="width: 250px;height: 300px;align-self: center;">
