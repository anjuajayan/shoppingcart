		...
		<div id="content">
			...
			<div class="shop-main container" style="margin-left:5px;">
				<div class="row">
					...
					{
						$se=$_POST['searchh'];
						$rt="select * from mag where name LIKE '%".$se."%'";
						$ry=mysqli_query($con,$rt);
		
						while($fetchh=mysqli_fetch_array($ry))
						{
										
						 ?>
						<div class="col-md-3 grid-item mb30"  style="margin-right:30px;margin-left:30px;margin-top:70px;">
								<h3 style="text-align:center;margin-top:90px;margin-bottom:30px;"><?php echo $fetchh['name'] ?></h3>
								<br><br><br>
								<div class="arrival-overlay" style="margin-top:80px;">
									<a href="cart.php?id=<?php echo $fetchh['id'] ?>" >	
										
										<img src="../admin/productimage/newspapers/<?php echo $fetchh['image'] ?>" alt="" width="40px" height="40px">
										<img src="../admin/productimage/magazines/<?php echo $fetchh['image'] ?>" alt="" width="40px" height="40px">
									</a>
								</div>
								<br><br>
							</div>
